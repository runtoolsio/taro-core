...
class LogMode(Enum):
    ...
    enabled, forwarded to the root logger, or disabled as needed by setting this mode of the parent logger.
    ...
    Attributes:
        ...
        PROPAGATE:
            ...
            This allows the logs to be handled and formatted according to the client of the library.
        DISABLED:
