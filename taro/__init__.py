...
def managed_job(job_id, job_execution, params, *ext, no_overlap=False, pending_value=None):
    mng_job = create_managed_job(job_id, job_execution, params, no_overlap=no_overlap, pending_value=pending_value)
